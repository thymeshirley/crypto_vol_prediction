...
.. code-block::
  ...
  $ conda activate crypto_vol_prediction
...
.. code-block::
  ...
  $ pytest tests
  $ crypto_vol_prediction train -c experiments/config.yml
...
.. code-block::
  ...
  crypto_vol_prediction train -c experiments/config.yml -r path/to/checkpoint
